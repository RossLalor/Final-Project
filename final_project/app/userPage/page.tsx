          ...
          <div className="flex justify-center py-10">
            <div className="max-w-screen-lg mx-auto grid grid-cols-2 gap-3">
              <div className="text-white-100 text-center hover:-translate-y-0 hover:scale-105 duration-500">
                ...
                Nations General Assembly in 2015. It aims to &quot;Ensure access
                ...
                indicators.[2] Three out of the five targets are outcome
                targets: Universal access to modern energy; increase global
                percentage of renewable energy; double the improvement in energy
                efficiency. The remaining two targets are means of
                implementation targets[3]:
                <div className="inline-block rounded-xl sm:text-[3.5rem] px-16 py-16 bg-[url('../images/wuh.png')] bg-cover transition ease-in-out hover:-translate-y-1 hover:scale-105 duration-300"></div>
                to promote access to research, technology and investments in
                clean energy; and expand and upgrade energy services for
                developing countries. In other words, these targets include
                access to affordable and reliable energy while increasing the
                share of renewable energy in the global energy mix. They also
                focus on improving energy efficiency, international cooperation
                and investment in clean energy infrastructure. According to a
                review report in 2019, some progress towards achieving SDG 7 is
                being made, but many of the targets of SDG 7 will not be
                met.[4]: 1  SDG 7 and SDG 13 (climate action) are closely
                related.[4]: 101
              </div>
              <div className="text-white-100 text-center hover:-translate-y-0 hover:scale-105 duration-500">
                <h2 className="text-white font-bold text-2xl mb-4">
                ...
                climate-related disasters; integrate climate change measures
                into policies and planning; build knowledge and capacity to meet
